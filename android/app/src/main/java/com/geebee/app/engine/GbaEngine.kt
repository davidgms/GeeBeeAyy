package com.geebee.app.engine

/**
 * JNI bridge to the GeeBee-A Rust core.
 *
 * Requires libgeebee_core.so to be loaded via System.loadLibrary("geebee_core").
 */
class GbaEngine {

    companion object {
        init {
            System.loadLibrary("geebee_core")
        }
