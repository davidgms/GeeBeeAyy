        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Text("GeeBee-A!")
                        .font(.system(size: GeeBeeDesign.fontBody, weight: .bold))
                ...
                .padding(.vertical, GeeBeeDesign.spacingSM)
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: GeeBeeDesign.radiusSM)
                        ...
                        .padding(.horizontal, GeeBeeDesign.spacingLG)
...
struct GameControlsView: View {
    ...
    var body: some View {
        HStack(spacing: GeeBeeDesign.spacingXL) {
            // D-Pad
            VStack(spacing: 0) {
        ...
        .padding(GeeBeeDesign.spacingLG)
    }
}
